...
//      }
    ...
    if(pe<0. || std::isnan(pe)==1) pe=1000.; // See commentary just above
    //20190212(finish)    
    ...
    if(std::isnan(thetae)) thetae=3.14;// See commentary just above
    //20190212(finish)    
  }
  ...
  if(!fe) {
    ...
    //20190226(start)
    fe->RotateZ(TMath::Pi());//20190226 added. To change electron from the left side to the right side of the beam-line (beam direction perspective)
    //20190226(finish)   
  }else{
