...
{
  // 20190410 Ho-San : range to detect electrons
  ...
  SetPAAcceptance(0.66323,0.31416,5.4978,0.78540);//No use.
...
{
  // 20190410 Ho-San : range to generate electrons
...
{ 
  ...
  Double_t Thetae=-TMath::ATan2(e->Px(),e->Pz());// To change electron from the left side to the right side of the beam-line (beam direction perspective)
